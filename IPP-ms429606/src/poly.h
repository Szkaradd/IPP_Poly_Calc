...
/**
 * Funkcja wykonująca składanie wielomianów. Dany jest wielomian p oraz k
 * wielomianów q_0, q_1, q_2, …, q_k−1. Niech l oznacza liczbę zmiennych wielomianu p
 * i niech te zmienne są oznaczone odpowiednio x_0, x_1, x_2, …, x_l−1.
 * Wynikiem złożenia jest wielomian p(q_0,q_1,q_2,…), czyli wielomian powstający
 * przez podstawienie w wielomianie p pod zmienną x_i wielomianu q_i dla
 * i = 0,1,2,…,min(k,l)−1. Jeśli k < l, to pod zmienne x_k, …, x_l−1 podstawiamy zera.
 * Na przykład, jeśli k = 0, to wynikiem złożenia jest liczba p(0,0,0,…).
 */
Poly PolyCompose(const Poly *p, size_t k, const Poly q[]);

/**
 * Funkcja wypisuje wielomian na standardowe wyjście.
 */
void PolyPrint(const Poly *p);

/**
 * Funkcja zakłada, że linia zawiera poprawnie opisany wielomian.
 * Tworzy wielomian z ciągu znaków.
 */
Poly PolyFromString(const char **line);

/**
 * Funkcja zakłada, że linia zawiera poprawnie opisany jednomian.
 * Tworzy jednomian z ciągu znaków.
 */
